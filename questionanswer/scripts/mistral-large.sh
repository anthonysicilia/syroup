...
# python3 -m src.predict --model=$model --temp=$temp --top_p=$p --data='bbh' --syco=1 --task='uqa' --usyco=20
# python3 -m src.predict --model=$model --temp=$temp --top_p=$p --data='mmlu' --syco=1 --task='uqa' --usyco=20
